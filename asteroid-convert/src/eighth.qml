...
Application {
    ...
    centerColor: "#c0c0c0"
    outerColor: "#808080"
    property string currentPage: "eighthPage"
    visible: currentPage === "eighthPage"

    property string displayText: "0"
    property bool isConversionMode: false
    property real inputValue: 0
    property string selectedUnit: ""
    property string baseUnit: "USD"

    // Fixed conversion rates (for offline use)
    property var rates: {
        "USD": 1.0,
        "EUR": 0.85,
        "GBP": 0.73,
    ...
    Row {
        ...
        Rectangle {
            ...
            MouseArea {
                anchors.fill: parent
                onClicked: {
                    const units = ["USD", "EUR", "GBP", "JPY", "CAD"];
    ...
    function convertValue() {
        const rate = rates[selectedUnit] / rates[baseUnit];
        app.displayText = (inputValue * rate).toFixed(2) + " " + selectedUnit;
    }
}
